...
CREATE TABLE [ONEFORALL].[SUCURSALES](
	...
	[SUC_ACTIVA] BIT NOT NULL DEFAULT 1
)
GO	
...
CREATE TABLE [ONEFORALL].[EMPRESAS](
	...
	[EMP_FECHA_RENDICION] INT NOT NULL
)
GO	
...
CREATE VIEW [ONEFORALL].[VW_SUCURSALES] 
	AS 
	SELECT s.SUC_ID as ID, s.SUC_NOMBRE AS NOMBRE,d.DIR_DIRECCION AS DIRECCION,d.DIR_CODIGO_POSTAL AS CP, d.DIR_PISO AS PISO, d.DIR_DEPARTAMENTO AS DEPARTAMENTO,d.DIR_LOCALIDAD AS LOCALIDAD, s.SUC_ACTIVA AS ACTIVA
