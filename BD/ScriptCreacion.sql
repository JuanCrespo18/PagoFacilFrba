...
SELECT        ONEFORALL.FACTURAS.FACT_ID, ONEFORALL.CLIENTES.CLIE_NOMBRE + N' ' + ONEFORALL.CLIENTES.CLIE_APELLIDO AS FACT_CLIE, ONEFORALL.EMPRESAS.EMP_NOMBRE AS FACT_EMP, 
                         ONEFORALL.FACTURAS.FACT_VENCIMIENTO, ONEFORALL.FACTURAS.FACT_ALTA, ONEFORALL.FACTURAS.FACT_REND_ID, ONEFORALL.FACTURAS.FACT_PAGO_ID, ONEFORALL.FACTURAS.FACT_TOTAL
